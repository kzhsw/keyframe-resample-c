import {PropertyType, Root} from "https://cdn.skypack.dev/@gltf-transform/core";
import {createTransform, dedup, isTransformPending} from 'https://cdn.skypack.dev/@gltf-transform/functions';
        ...
        for (const animation of document.getRoot().listAnimations()) {
            ...
            for (const sampler of animation.listSamplers()) {
                ...
                if (interpolation === 'STEP' || interpolation === 'LINEAR') {
                    ...
                    optimize(sampler, targetPath, options, wrapper, logger, options.stats);
                } else {
 ...
 * @param {import('./animation-resample.d.ts').AnimationResampleWrapper} w
